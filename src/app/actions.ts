...
// Phase A PR #4 (HANDOFF.md): canEditList moved to `src/lib/lists-server.ts`.
// It's still used internally by future-migration server actions in this file
// (invites, collaborators, etc.); they import it from the lib module.
